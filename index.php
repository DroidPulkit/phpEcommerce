...
<?php require "header.php"; ?>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="hero-content">
                        ...
                        <a href="#homepage_collection" class="btn essence-btn">view collection</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="top_catagory_area section-padding-80 clearfix" id="homepage_collection">
        <div class="container">
                ...
                <div class="col-12">
                    <div class="cta-content bg-img background-overlay" style="background-image: url(img/bg-img/bg-5.jpg);">
                        <div class="h-100 d-flex align-items-center justify-content-end">
                            <div class="cta--text">
                                <h6>Upto 15% discount</h6>
                                <h2>Member's Discount</h2>
                                <a href="#" class="btn essence-btn">Login / Register</a>
                            </div>
                        </div>
                    </div>
                </div>
